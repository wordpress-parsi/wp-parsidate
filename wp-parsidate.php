...
final class WP_Parsidate {
   ...
   *
   * The autoloader in packages/ is generated by wp-scoper (composer install).
   * It loads both the plugin's own classes (inc/) and the prefixed
   * third-party dependencies, so vendor/ is not needed at runtime.
   *
   * @return void
   */
