...
if ( ! class_exists( 'WPP_WC_Melli_Gateway_Blocks' ) ) {
  final class WPP_WC_Melli_Gateway_Blocks extends AbstractPaymentMethodType {
    ...
    public function get_payment_method_script_handles() {
      ...
      wp_register_script(
        $script_id,
        Assets::url( "js-admin/wc-pg-blocks/$script_name" ),
        array(
          'wc-blocks-registry',
          'wc-settings',
          'wp-element',
