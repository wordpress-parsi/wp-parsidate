<?php
/**
 * Makes Parsigate compatible with WP-Parsidate plugin
 *
...
class ParsigateDemo extends Addon {
  ...
  public function info(): array {
    ...
    return array(
      ...
      'is_suggested'     => true,
      'icon'             => $svg,
      'image_link'       => 'https://wordpress.org/plugins/parsigate/',
      'tags'             => [ esc_html__( 'Payment', 'wp-parsidate' ) ],
      'cat'              => 'recommended',
      'requires_plugins' => [
        'parsigate/ParsiGate.php' => array(
          'is_wp_plugin' => true,
          'is_free'      => true,
          'plugin_link'  => 'https://wordpress.org/plugins/parsigate/',
          'class_check'  => 'ParsiGate'
        )
      ]
    );
  }
