...
class AdminPages {
  ...
  public function addMenu(): void {
    ...
    add_menu_page( __( 'WP Parsi', 'wp-parsidate' ), __( 'WP Parsi', 'wp-parsidate' ), 'manage_options',
      WP_PARSI_KEY_SLUG,
      [ $this, 'mainPage' ], $icon );
  }
        ...
        <div class="wppd-sidebar" id="wppd-sidebar">
          <div class="wppd-sidebar-head">
            <div class="wppd-logo-wrap">
              ...
              <div>
                <span><?php _e( 'WordPress', 'wp-parsidate' ); ?></span>
                <span><?php _e( 'Parsi', 'wp-parsidate' ); ?></span>
              </div>
            </div>
